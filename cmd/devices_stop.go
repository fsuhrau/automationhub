...
// deviceStopCmd represents the stop command
...
func init() {
	...
	// deviceStopCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// deviceStopCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}

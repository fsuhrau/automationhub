...
// Package renderer provides some sugar for gin's template rendering
//
...
//
//
// And if you want to render `templates/articles/index.html` in your handler
//
...
// For example, if the template path is `templates/articles/index.html`
